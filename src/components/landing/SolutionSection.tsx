        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto">
          {features.map((feature, i) => (
            <AnimatedSection key={feature.title} delay={i * 0.08}>
              <div className="group rounded-2xl p-6 h-full border border-white/10 bg-white/[0.03] backdrop-blur-sm hover:border-primary/20 hover:-translate-y-1 transition-all duration-300">
