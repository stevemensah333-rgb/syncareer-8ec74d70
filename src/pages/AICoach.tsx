...
export default function AICoach() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "👋 Hi! I'm SkillBridge AI, your career counsellor. I'm here to help you with career guidance, skill development, CV tips, interview prep, and connecting your skills to opportunities. How can I assist you today?"
    }
  ]);
  ...
  return (
    <PageLayout title="SkillBridge AI">
